...
class Test_searchCustomerbyName__007():
    ...
    def test_searchcustomerbyname(self,setup):
        self.logger.info("***************   Test_searchCustomerbyName__007 Starting     ***************")
        self.driver = setup
        ...
        self.npSearchCust.setFirstname('Victoria')
        self.npSearchCust.setLastname('Terces')
        self.npSearchCust.clickSearchbutton()
        self.npSearchCust.getNoofrows()
        self.logger.info('-----------Checking customer details on the search table----------------')
        time.sleep(2)
        status = self.npSearchCust.SearchCutomerbyname("Victoria Terces")
        self.driver.close()
        assert True == status
        self.logger.info("***************  Test_searchCustomerbyName__007 Passed  *********** ")
        self.logger.info("***************  Test_searchCustomerbyName__007 Finished  *********** ")
